...
* Metadata about the texts should be encoded in the filenames. For example, if you
want to be able to display the titles and author names of the books in the corpus,
all file name should have the following format: `author_title.txt` (without spaces), 
